                    ...
                    <div className="row g-4 w-100 justify-content-center">
                        ...
                        <div className="col-12 col-md-6 col-lg-5">
                            <div className="p-4 p-lg-5 rounded" style={{
                                ...
                                <div className="mb-5">
                                    <h3 className="fs-4 mb-4" style={{ color: "#FFC107" }}>Contact Information</h3>
                                    ...
                                    <div className="d-flex align-items-center gap-3 mb-4 p-3 rounded" style={{ backgroundColor: "#1f2937" }}>
                                        <div style={{
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="22" fill="#FFC107" viewBox="0 0 16 16">
                        ...
                        <div className="col-12 col-md-6 col-lg-7">
                            <div className="p-4 p-lg-5 rounded" style={{
                                ...
                                <h3 className="fs-4 mb-4" style={{ color: "#FFC107" }}>Send me a message</h3>
