...
import p5 from '../assets/busify.png';
            ...
            <div className="container pb-5">
                ...
                <div className="d-flex flex-column flex-lg-row-reverse mb-5">
                    <div className="col-lg-6 p-4" style={{ backgroundColor: "#374151" }}>
                        <img src={p5} alt="Project Screenshot" width="100%" className="rounded-4" />
                    </div>
                    <div className="col-lg-6 p-4" style={{ backgroundColor: "#1F2937" }}>
                        <h2>Busify - Web based Bus Tracking System</h2>
                        <p style={{ textAlign: "justify" }}>
                           The Web-Based Bus Tracking System is a real-time solution designed to monitor and display the live location of buses through a web application. It collects GPS data directly from the driver’s mobile phone or the onboard ticketing machine and continuously updates the bus position on an interactive map. This allows passengers and transport authorities to track bus movement, routes, and estimated arrival times accurately. The system improves operational efficiency, reduces passenger waiting time, and enhances the overall reliability of public transportation.
                        </p>
                        <div className="d-flex flex-wrap gap-2 mb-3">
                            ...
                            <span className="px-3 py-1 rounded-pill text-light" style={{ backgroundColor: "#374151" }}>Bootstrap</span>
                        ...
                        <div className="d-flex gap-4 align-items-center">
                            <a href="https://bus-track-ebon.vercel.app/" target="_blank" rel="noopener noreferrer" aria-label="Visit Project">
                            ...
                            <a href="https://github.com/SakthivelChermachsamy/Bus-Track" target="_blank" rel="noopener noreferrer" aria-label="Visit Project">
