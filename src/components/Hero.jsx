                    ...
                    <div className="col-lg-6 d-flex flex-column justify-content-center align-items-center">
                        <div>
                            ...
                            <div className="d-flex gap-3 mt-3 mb-5">
                                <a href="" className='btn btn-light rounded-circle skill-icon'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor" className="bi bi-person-rolodex" viewBox="0 0 16 16">
                                ...
                                <a href="" className='btn btn-light rounded-circle skill-icon'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor" className="bi bi-github" viewBox="0 0 16 16">
